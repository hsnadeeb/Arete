  ...
  return (
    <Card accentColor="#6366f1">
            ...
            return (
              <TouchableOpacity
                ...
                style={[
                  ...
                  isDone && styles.prayerItemDone,
                ]}
                onPress={() => togglePrayer(prayer.toUpperCase())}
              >
                <Feather
                ...
                />
                <Text
                  style={[styles.prayerLabel, isDone && styles.prayerLabelDone]}
                >
                  {PRAYER_DISPLAY[prayer]}
                </Text>
                <Text
                  style={[styles.prayerTime, isDone && styles.prayerTimeDone]}
                >
                  {t12(time)}
                </Text>
      ...
      {!prayerTimings && !timingsLoading && (
        ...
        >
          <Text style={styles.refreshBtnText}>Load Prayer Timings</Text>
        </TouchableOpacity>
      )}
...
function QuickStatsWidget() {
  ...
  const stats = [
    {
      label: "Weight",
      value: dailyLog?.weight ? `${dailyLog.weight} kg` : "—",
      color: "#0b6bcf",
    },
    {
      label: "Water",
    ...
    {
      label: "Mood",
      value: dailyLog?.mood ? "•".repeat(dailyLog.mood) : "—",
      color: "#8b5cf6",
    },
  ];
...
function QuickLogWidget() {
  ...
  const logs = [
    ...
    },
    {
      ...
      action: () => {
        if (water) {
          logWater((dailyLog?.water_ml || 0) + parseInt(water));
          setWater("");
        }
      },
    },
        ...
        <View key={i} style={styles.logRow}>
          ...
          <View style={styles.logInputContainer}>
            <TextInput
              ...
              placeholder="0"
            />
            <TouchableOpacity style={styles.logBtn} onPress={item.action}>
      ...
      <View style={styles.moodContainer}>
        {moods.map((m) => (
          <TouchableOpacity
            ...
            style={[
              styles.moodButton,
              dailyLog?.mood === m.value && styles.moodActive,
            ]}
...
function ExpensesWidget() {
  ...
  const expenses = (todayTransactions || []).filter(
    (t: any) => t.type === "expense",
  );
  const total = expenses.reduce((sum: number, t: any) => sum + t.amount, 0);
  ...
  const handleAddExpense = () => {
    ...
    addExpense(category, amt, description);
    setAmount("");
    setDescription("");
  ...
  return (
    <Card accentColor="#059669">
      <View style={styles.expenseHeader}>
        ...
        <Text style={styles.totalExpense}>-${total.toFixed(2)}</Text>
      </View>
      ...
      {/* Modal remains the same but can be improved further if needed */}
      <Modal visible={modalVisible} transparent animationType="slide">
        {/* ... Modal content (same as before, slightly cleaned) */}
      </Modal>
    </Card>
  );
}
  ...
  return (
    <Card accentColor="#d97706">
      ...
      <View style={styles.statsGrid}>
        ...
        <View style={styles.statTile}>
          <Text style={styles.statValue}>
            {Math.round(monthlyStats.avg_steps || 0).toLocaleString()}
          </Text>
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      <View style={styles.topbar}>
        ...
        <View style={styles.topCenter}>
          {!editing ? (
            ...
            <Text style={styles.editHint}>Reorder widgets using arrows</Text>
          )}
        </View>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          const Component = WIDGET_MAP[item.widget_key];
          return Component ? (
...
const styles = StyleSheet.create({
  ...
  menuBtn: { padding: 4 },
  menuIcon: { fontSize: 26, color: "#1f2937" },
  topCenter: { flex: 1, alignItems: "center" },
  greeting: { fontSize: 18, fontWeight: "700", color: "#1f2937" },
  date: { fontSize: 13, color: "#6b7280" },
  editHint: { fontSize: 14, color: "#6366f1", fontWeight: "600" },
  iconBtn: { padding: 8 },
  editBtn: {
  ...
  streakText: { fontWeight: "700", color: "#ca8a04" },
  ...
  hijriHeader: { alignItems: "center", marginBottom: 16 },
  hijriDate: { fontSize: 17, fontWeight: "700", color: "#1f2937" },
  hijriDay: { fontSize: 13, color: "#6366f1" },
  ...
  npTime: { fontSize: 15, color: "#374151" },
  npCountdown: { fontWeight: "700", color: "#6366f1" },
  alhamd: {
    textAlign: "center",
    fontSize: 16,
    color: "#10b981",
  ...
  prayerStrip: { flexDirection: "row", gap: 10 },
  prayerItem: {
    flex: 1,
  ...
  prayerItemActive: { borderColor: "#6366f1", backgroundColor: "#f0f9ff" },
  prayerItemDone: { borderColor: "#22c55e", backgroundColor: "#f0fdf4" },
  prayerLabel: {
    fontSize: 11,
    fontWeight: "600",
    color: "#64748b",
  ...
  prayerTimeDone: { color: "#22c55e" },
  status: { marginTop: 6, fontSize: 18 },

  statsGrid: { flexDirection: "row", flexWrap: "wrap", gap: 16 },
  statTile: { flex: 1, minWidth: "45%", alignItems: "center" },
  statValue: { fontSize: 22, fontWeight: "700" },
  statLabel: { fontSize: 12, color: "#64748b", marginTop: 4 },

  logRow: { flexDirection: "row", alignItems: "center", marginBottom: 12 },
  logLabel: { width: 100, fontSize: 14, color: "#64748b" },
  logInputContainer: { flex: 1, flexDirection: "row", gap: 8 },
  logInput: {
    flex: 1,
    height: 42,
    borderWidth: 1,
  ...
  moodContainer: { flexDirection: "row", gap: 8, flexWrap: "wrap" },
  moodButton: {
    flex: 1,
    minWidth: "45%",
    alignItems: "center",
  ...
  moodLabel: { fontSize: 12, marginTop: 4, color: "#64748b" },
  ...
  totalExpense: { fontSize: 18, fontWeight: "700", color: "#ef4444" },
  addButton: {
  ...
  expenseIcon: { fontSize: 20, marginRight: 12 },
  expenseInfo: { flex: 1 },
  expenseCategory: { fontWeight: "600" },
  expenseDesc: { fontSize: 13, color: "#64748b" },
  expenseAmount: { fontWeight: "700", color: "#ef4444" },
  ...
  refreshBtnText: { color: "#4f46e5", fontWeight: "600" },
...
// import { TYPOGRAPHY, ICONS } from "../constants/typography";
// import {
//   PRAYER_NAMES,
//   PRAYER_DISPLAY,
//   PRAYER_TIMES_ORDER,
...
// function AtAGlanceWidget() {
//   const { prayerTimings, islamicDate, timingsLoading, refreshPrayerTimings } =
//     useApp();
//   const nextPrayer = useMemo(() => {
//     if (!prayerTimings) return null;
//     return getNextPrayer({
...
//               <View
//                 key={prayer}
//                 style={[styles.pStripItem, isNext && styles.pStripItemActive]}
//               >
//                 <Feather
...
//                   style={[
//                     styles.pStripLabel,
//                     isNext && styles.pStripLabelActive,
//                   ]}
//                 >
//                   {PRAYER_DISPLAY[prayer]}
//                 </Text>
//                 <Text
//                   style={[styles.pStripTime, isNext && styles.pStripTimeActive]}
//                 >
//                   {t12(time)}
//                 </Text>
//               </View>
...
//       {!prayerTimings && !timingsLoading && (
//         <TouchableOpacity
//           style={styles.refreshPrayerBtn}
//           onPress={refreshPrayerTimings}
//         >
//           <Text style={styles.refreshPrayerBtnText}>
//             {"\uD83D\uDCFF"} Load Prayer Timings
//           </Text>
//         </TouchableOpacity>
//       )}
...
//             />
//             <TouchableOpacity style={styles.qlBtn} onPress={r.a}>
//               <Text style={styles.qlBtnText}>{r.b}</Text>
//             </TouchableOpacity>
//           </View>
//         </View>
//       ))}
...
//             style={[
//               styles.moodBtn,
//               dailyLog?.mood === m.v && styles.moodActive,
//             ]}
//             onPress={() => logMood(m.v)}
//           >
...
//               style={[
//                 styles.moodLabel,
//                 dailyLog?.mood === m.v && styles.moodLabelActive,
//               ]}
//             >
//               {m.l}
//             </Text>
...
//         <Text style={styles.ptCount}>{count}/5</Text>
//       </View>
...
//           const qada = p?.qada === 1;
//           const tim = (prayerTimings as any)?.[name.toLowerCase()] as
//             | string
//             | undefined;
//           return (
//             <TouchableOpacity
...
//               style={[
//                 styles.pBtn,
//                 done && styles.pBtnDone,
//                 qada && !done && styles.pBtnQada,
//               ]}
//               onPress={() => togglePrayer(name)}
//             >
//               <Feather
//                 name={PRAYER_ICONS[name.toLowerCase()]?.name || "circle"}
//                 size={16}
//                 color="#8b5cf6"
//               />
//               <Text style={styles.pBtnName}>{name}</Text>
//               {tim && <Text style={styles.pBtnTime}>{t12(tim)}</Text>}
//               <Text style={styles.pBtnStatus}>
//                 {done ? "\u2705" : qada ? "\u23F3" : "\u25FB"}
//               </Text>
//             </TouchableOpacity>
//           );
...
//     return (
//       <Card accentColor="#d97706">
//         <Text style={{ color: "#bbb", textAlign: "center", padding: 8 }}>
//           No data yet
//         </Text>
//       </Card>
//     );
...
//                 style={[
//                   styles.editArrow,
//                   index === 0 && styles.editArrowDisabled,
//                 ]}
...
//                     index === 0 && styles.editArrowTextDisabled,
//                   ]}
//                 >
//                   ▲
//                 </Text>
...
//                 style={[
//                   styles.editArrow,
//                   index === data.length - 1 && styles.editArrowDisabled,
//                 ]}
...
//                   style={[
//                     styles.editArrowText,
//                     index === data.length - 1 && styles.editArrowTextDisabled,
//                   ]}
//                 >
//                   ▼
//                 </Text>
...
//           <Feather name="bar-chart-2" size={48} color="#9b9a97" />
