...
export default function PlannerScreen() {
  ...
  const weeks = useMemo(() => {
    ...
    for (let i = 0; i < first; i++)
      cells.push({ day: 0, month, year, isCurrent: false, isToday: false });
    ...
    >
      ...
      >
        ...
        >
          <TouchableOpacity
            onPress={() => navigate(-1)}
            style={[styles.navBtn, { backgroundColor: T.borderSoft }]}
          >
            <Icon
              name={LUCIDE_ICONS.chevronLeft}
              size={16}
              color={T.textPrimary}
            />
          </TouchableOpacity>
        ...
        <View style={[styles.dayNames, { backgroundColor: T.surface }]}>
          {["S", "M", "T", "W", "T", "F", "S"].map((d, i) => (
            <View key={`dn-${i}`} style={styles.dayNameCell}>
              <Text style={[styles.dayNameText, { color: T.textMuted }]}>
                {d}
              </Text>
            </View>
          ))}
              ...
              {week.map((cell, ci) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.calCell,
                      !cell.isCurrent && styles.calCellDimmed,
                    ]}
                    onPress={() => {
                      if (cell.isCurrent)
                        toggleDate(cell.year, cell.month, cell.day);
                    }}
                        ...
                        >
                          <Text
                            style={[
                              ...
                              isSel &&
                                !isT && { color: T.accent, fontWeight: "600" },
                            ]}
                          >
                            {cell.day}
                          </Text>
        ...
        {sortedDates.length > 0 && (
          <View
            style={[
              ...
              {
                backgroundColor: T.surface,
                borderBottomColor: T.borderCalendar,
              },
            ]}
          >
      ...
      <Modal visible={modalMode !== null} transparent animationType="fade">
        <View
          style={[styles.modalOverlay, { backgroundColor: T.modalOverlay }]}
        >
          ...
          >
              ...
              {COLORS.map((c2) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.colorDot,
                    { backgroundColor: c2 },
                    itemColor === c2 && { borderColor: T.textPrimary },
                  ]}
              ...
              {["weekly", "daily", "once"].map((r) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    repeatType === r && { backgroundColor: T.accentSoft },
                  ]}
            ...
            <View style={styles.modalActions}>
              <TouchableOpacity
                style={[styles.cancelBtn, { backgroundColor: T.borderSoft }]}
                onPress={() => setModalMode(null)}
              >
                <Text
                  style={[styles.cancelBtnText, { color: T.textSecondary }]}
                >
                  Cancel
                </Text>
              </TouchableOpacity>
              ...
              {modalMode === "edit" && (
                <TouchableOpacity
                  style={[styles.deleteBtn, { backgroundColor: T.errorBg }]}
                  onPress={deleteItem}
                >
              ...
              >
                <Text style={[styles.saveBtnText, { color: T.textInverse }]}>
