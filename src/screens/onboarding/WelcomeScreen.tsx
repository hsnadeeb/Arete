    ...
    <SafeAreaView style={[styles.container, { backgroundColor: tc.bg }]}>
      <View style={styles.content}>
        ...
        >
          ...
          <Image
            source={require("../../../assets/icon.png")} // adjust the path
            style={styles.logo}
          />
        </Animated.View>
        ...
        >
          ...
          <Text style={[styles.subtitle, { color: tc.textSecondary }]}>
            Your personal companion for building better habits, tracking
          ...
          <View style={styles.features}>
            <View style={styles.feature}>
              <View
                style={[styles.featureIcon, { backgroundColor: tc.accentBg }]}
              >
                <Icon
              ...
              <Text style={[styles.featureText, { color: tc.text }]}>
                Track Everything
              </Text>
            </View>
            <View style={styles.feature}>
